...
class TextClassifier {
  ...
  public static void main(String[] args) throws Exception {
    ColumnDataClassifier cdc = new ColumnDataClassifier("poet.prop");
    Classifier<String,String> cl =
      cdc.makeClassifier(cdc.readTrainingExamples("poet_1.train"));
    for (String line : ObjectBank.getLineIterator("poet_1.test", "utf-8")) {
  ...
  public static void demonstrateSerialization()
    ...
    ois.close();
    ColumnDataClassifier cdc2 = new ColumnDataClassifier("poet.prop");
